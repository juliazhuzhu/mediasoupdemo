...
export default class PeerView extends React.Component
{
	...
	render()
	{
		...
		console.log("sharingContent---------------",sharingContent)
		return (
	...
	componentDidMount()
	{
		const { audioTrack, videoTrack, contentTrack, sharingContent} = this.props;

		if (sharingContent)
			this._setTracks(audioTrack,contentTrack,sharingContent);
		else
			this._setTracks(audioTrack, videoTrack,sharingContent);
	}
	...
	_setTracks(audioTrack, videoTrack, sharingContent)
	{
