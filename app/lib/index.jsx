...
async function run()
{
	...
	const forceVP8 = false;//urlParser.query.forceVP8 === 'true';
	const forceH264 = true;//urlParser.query.forceH264 === 'true';
	const forceVP9 = false;//urlParser.query.forceVP9 === 'true';
	const enableWebcamLayers = true;//urlParser.query.enableWebcamLayers !== 'false';
	const enableSharingLayers = true;//urlParser.query.enableSharingLayers !== 'false';
	const webcamScalabilityMode = true;//urlParser.query.webcamScalabilityMode;
	const sharingScalabilityMode = true;//urlParser.query.sharingScalabilityMode;
	const numSimulcastStreams = 2;//urlParser.query.numSimulcastStreams ?
