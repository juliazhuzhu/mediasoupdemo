...
export default class PeerView extends React.Component
{
	...
	componentDidMount()
	{
		const { audioTrack, videoTrack, contentTrack} = this.props;

		this._setTracks(audioTrack, videoTrack,contentTrack);
	}
	...
	_setTracks(audioTrack, videoTrack, contentTrack)
	{
		const { faceDetection } = this.props;

		if (this._audioTrack === audioTrack && this._videoTrack === videoTrack && this._contentTrack == contentTrack)
			return;

		this._audioTrack = audioTrack;
		this._videoTrack = videoTrack;
		this._contentTrack = contentTrack;
...
PeerView.propTypes =
{
	...
	contentTrack                   : PropTypes.any,
	audioMuted                     : PropTypes.bool,
	videoVisible                   : PropTypes.bool.isRequired,
	videoMultiLayer                : PropTypes.bool,
	audioCodec                     : PropTypes.string,
	contentCodec                   : PropTypes.string,
